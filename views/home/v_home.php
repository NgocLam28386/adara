                        ...
                        <div class="slider-bg" data-background="public/layout/img/slider/slider_bg01.jpg">
                            <div class="slider-content">
                                <h3 class="sub-title animated" data-animation-in="fadeInUp" data-delay-in=".2">
                                    top deal !</h3>
                                <h2 class="title animated" data-animation-in="fadeInUp" data-delay-in=".4">New
                                    Season</h2>
                                <p class="animated" data-animation-in="fadeInUp" data-delay-in=".6">Get up to
                                    50% off Today Only</p>
                                <a href="shop-sidebar.html" class="btn animated" data-animation-in="fadeInUp"
            ...
            <div class="col-lg-6 col-md-12 col-sm-10">
                <div class="row">
                    <div class="col-md-6">
                        <div class="cat-banner-item banner-animation mb-20">
                            <div class="thumb">
                                <a href="shop-sidebar.html"><img src="public/layout/img/images/cat_banner_img02.jpg"
                                        alt=""></a>
                            </div>
                            <div class="content">
                    ...
                    <div class="col-md-6">
                        <div class="cat-banner-item banner-animation mb-20">
                            <div class="thumb">
                                <a href="shop-sidebar.html"><img src="public/layout/img/images/cat_banner_img03.jpg"
                                        alt=""></a>
                            </div>
                            <div class="content">
                                <span>NEW COLLECTION</span>
                    ...
                    <div class="col-12">
                        <div class="cat-banner-item style-two banner-animation mb-20">
                            <div class="thumb">
                                <a href="shop-sidebar.html"><img src="public/layout/img/images/cat_banner_img04.jpg"
                                        alt=""></a>
                            </div>
                            <div class="content">
                                <span>NEW COLLECTION</span>
